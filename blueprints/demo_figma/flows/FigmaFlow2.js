// @title Figma Design Handoff Exporter With Component Inventory Flow 2
...
async function run($page, $input) {
  return $generateResponseSuccess('Figma Design Handoff Exporter With Component Inventory Flow 2 completed', {
