// @title Analytics Export And Narrative Insight Generator Flow 2
...
async function run($page, $input) {
  return $generateResponseSuccess('Analytics Export And Narrative Insight Generator Flow 2 completed', {
