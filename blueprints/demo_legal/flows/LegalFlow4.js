// @title Legal Intake Entity Extraction And Case Summary Flow 4
...
async function run($page, $input) {
  return $generateResponseSuccess('Legal Intake Entity Extraction And Case Summary Flow 4 completed', {
