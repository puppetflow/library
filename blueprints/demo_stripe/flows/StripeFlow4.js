// @title Stripe Billing Monitoring And Customer Snapshot Flow 4
...
async function run($page, $input) {
  return $generateResponseSuccess('Stripe Billing Monitoring And Customer Snapshot Flow 4 completed', {
