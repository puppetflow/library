// @title Linear Issue Grooming And Sprint Planning Assistant Flow 4
...
async function run($page, $input) {
  return $generateResponseSuccess('Linear Issue Grooming And Sprint Planning Assistant Flow 4 completed', {
