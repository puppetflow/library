// @title Linear Issue Grooming And Sprint Planning Assistant Flow 8
...
async function run($page, $input) {
  return $generateResponseSuccess('Linear Issue Grooming And Sprint Planning Assistant Flow 8 completed', {
